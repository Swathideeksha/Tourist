...
const RouteBanner = () => {
  return (
    <div className="px-4 md:px-10 py-6 md:py-8">
      ...
      >
        <h2 className="text-lg md:text-xl font-bold mb-2">🗺️ Explore Routes</h2>
        <p className="text-sm md:text-base opacity-90">Discover scenic routes and plan your journey</p>
      </Link>
    </div>
  );
};
