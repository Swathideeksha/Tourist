    ...
    <section className="py-24 bg-white dark:bg-slate-900">
      <div className="max-w-7xl mx-auto px-8">
        ...
        <div className="text-center mb-20">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-red-700 dark:text-red-500 mb-4">
            Cultural Tapestry
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          {/* Card 1 */}
          <div className="relative bg-white dark:bg-slate-800 rounded-3xl shadow-[0_15px_40px_rgba(0,0,0,0.08)] p-10 text-center">
            <span className="material-symbols-outlined text-4xl text-red-600 mb-6 block">
              theater_comedy
            </span>
