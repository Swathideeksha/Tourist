...
import devbaghBeachImg from "../assests/devbagh-beach.jpg";
import MalpeBeachImg from "../assests/Malpe.jpg";
import MattuBeachImg from "../assests/Mattu.jpg";
import MurudeshwaraBeachImg from "../assests/murudeshwara-beach.jpg";
import OmBeachImg from "../assests/om-beach.jpg";
import PanamburuBeachImg from "../assests/panambur-beach.jpg";
import SomeshwaraBeachImg from "../assests/someshwara.jpg";
import StMarryBeachImg from "../assests/St.Marry-island.jpg";
import SurathkalBeachImg from "../assests/surathkal-beach.jpg";
import ThannirbhaviBeachImg from "../assests/tannirbhavi-beach.jpg";
import MaravantheBeachImg from "../assests/Maravanthe.avif";
...
const places = [
  {
    ...
    image: sakleshpurImg,
    about: `Sakleshpur is a scenic hill town in the Hassan district of Karnataka, located in the Western Ghats.
It is known for its cool climate, lush greenery, and coffee plantations.

Historically, Sakleshpur was ruled by the Chalukyas, Hoysalas, and later the Kingdom of Mysore.
The famous Manjarabad Fort was built by Tipu Sultan in 1792 and still stands today.`,
...

  {
    ...
    region: "Western Ghats",
    image: coorgImg,
    about: `Coorg (Kodagu) is a popular hill station in Karnataka, famous for its misty hills,
coffee estates, waterfalls, and rich culture.

It has a unique history and was ruled by local dynasties before coming under British control.
Today, Coorg is known as the "Scotland of India".`,
...

  {
    ...
    type: "Hill Station",
    region: "Western Ghats",
    image: chikamagalurImg,
    about: `ChikmagalurOr Chikmagalur is a district in the state of Karnataka. Coffee was first cultivated in Chikmagalur in India. The Chikmagalur Mountains, which are part of the Western Ghats, are the source of rivers like Tunga and Bhadra. It is located in the Mullayagiri district of Karnataka, the highest peak. It is a tourist haven of Kemmannugundi and Kudremukh and Manikadhar, Hebbe and Kallathigiri Falls. Chikmagalur district has a rich history in Hoysala temple in Amritsar. Wildlife enthusiasts are interested in the Kudremukh National Park and Bhadra Wildlife Sanctuary in the district.
HistoryChikmagalur spent the early days of the Hoysala kings and their dynasty. According to a legend, it is in Sussevar, now identified with Angadi in the Mudikere taluk, killing the mythical assassination of the Hoysala dynasty founder Sala Hoysala Crest.
...
Today, Coorg is known as the "Scotland of India".`,
...

  {
    ...
    region: "Western Ghats",
    image: bilgiriImg,
    about: `Biligiriranga Hills, or BR Hills, is a scenic hill range in Chamarajanagar District, South-Eastern Karnataka, renowned for the BRT Wildlife Sanctuary, a unique,biodiverse ecosystem where the Eastern and Western Ghats meet. Situated at 5,091 feet, it is a popular destination for tiger safaris, birdwatching, and visiting the ancient Biligiri Rangaswamy Temple. 
    Important Information:
Forest Safaris: Forest Department safaris are available, offering chances to see wildlife like elephants and deer.
Travel Tips: The road to the top is open from 6 am to 7 pm. It is advisable to carry essential supplies, such as water and snacks, as options are limited at the top.
Stay: Accommodation options include the KSTDC Hotel Mayura and local eco-resorts like Gorukana. `,
    bestTime: "October to March",
  },

   {
    ...
    region: "Western Ghats",
    image: gangamoolaImg,
    about: `Gangamoola, located in the Chikkamagaluru district of Karnataka, India, is a significant ecological site in the Western Ghats within the Kudremukh National Park. Known as the birthplace of three rivers—Tunga, Bhadra, and Netravathi—this 1458-meter-high hill, also called Varaha Parvatha, is a biodiversity hotspot featuring dense forests and a cave shrine dedicated to Goddess Bhagavathi and Varaha. 
    Source of Rivers: It is the origin point for the Tunga and Bhadra rivers (which form the Tungabhadra) and the Netravathi river.
    Attractions: The area features a cave containing a 1.8-meter-high Varaha image and a shrine of Goddess Bhagavathi. `,
    bestTime: "October to March",
  },
...

  {
    ...
    type: "Hill Station",
    region: "Western Ghats",
    image: kemmannugundiImg,
    about: `Kemmannugundi (Red Soil Pit) is a hill station in Tarikere taluk of Chikkamagaluru district in the state of Karnataka, India. It is at the elevation of 1434m above sea level, with its peak at 1863m.[1] This was the summer retreat of Krishnaraja Wodeyar IV, and as a mark of respect to the king, it is also known as Sri Krishnarajendra Hill Station. The station is ringed by the Baba Budan Giri Range, with cascades, mountain streams, and lush vegetation. Kemmangundi has ornamental gardens and mountains and valleys views.
...
// ================= BEACHES =================
{
    ...
    name: "Kapu Beach",
    type: "Beach",
    region: "Karavali Coast",
    image: kapuBeachImg,
    about: `Kapu Beach is a beautiful coastal destination in Udupi district, Karnataka. Famous for its iconic lighthouse and vibrant fishing community, this beach offers a perfect blend of natural beauty and local culture. The beach is known for its golden sand, swaying palm trees, and stunning sunrise views.`,
...

{
    ...
    type: "Beach",
    region: "Karwar",
    image: devbaghBeachImg,
    about: `Devbagh Beach is a pristine beach located near Karwar in Karnataka. Known for its serene atmosphere and lush coconut groves, this beach is perfect for those seeking tranquility. The beach offers opportunities for water sports and is famous for its delicious seafood.`,
    bestTime: "October to March",
},

{
    ...
    region: "Udupi",
    image: MalpeBeachImg,
    about: `Malpe Beach is a popular beach destination near Udupi, known for its long stretch of golden sand and clear waters. It's a major fishing harbor and offers various water activities including boat rides to St. Mary's Island. The beach is lined with restaurants serving fresh seafood.`,
    bestTime: "October to May",
},

{
    ...
    region: "Udupi",
    image: MattuBeachImg,
    about: `Mattu Beach is a serene beach in Udupi district, known for its peaceful atmosphere and beautiful sunsets. The beach is less crowded compared to other beaches in the area, making it perfect for relaxation and peaceful walks along the shore.`,
    bestTime: "October to March",
},

{
    ...
    type: "Beach",
    region: "Bhatkal",
    image: MurudeshwaraBeachImg,
    about: `Murudeshwara Beach is famous for its massive Lord Shiva statue and the Murudeshwara Temple perched on a hill. The beach offers stunning views of the Arabian Sea and the Gopuram of the temple. It's a pilgrimage destination as well as a tourist spot.`,
    bestTime: "October to May",
},

{
    ...
    region: "Gokarna",
    image: OmBeachImg,
    about: `Om Beach in Gokarna is named after its shape which resembles the Hindi/Sanskrit symbol 'Om'. This beach is famous among backpackers and offers a perfect blend of spirituality and beach culture. The beach has shacks, cafes, and opportunities for yoga and meditation.`,
    bestTime: "October to March",
},

{
    ...
    type: "Beach",
    region: "Mangaluru",
    image: PanamburuBeachImg,
    about: `Panamburu Beach is a beautiful beach near Mangalore, known for its clean waters and black sand. The beach is popular among locals and offers various water sports activities. It's an ideal spot for families and those looking to enjoy a day by the sea.`,
    bestTime: "October to May",
},

{
    ...
    type: "Beach",
    region: "Mangaluru",
    image: SomeshwaraBeachImg,
    about: `Someshwara Beach is located near Mangalore and is known for its serene environment and the Someshwara Temple nearby. The beach offers a peaceful retreat with its calm waters and is less crowded compared to other beaches in the region.`,
    bestTime: "October to March",
},

{
    ...
    type: "Beach",
    region: "Udupi",
    image: StMarryBeachImg,
    about: `St. Mary's Island is a group of islands off the coast of Malpe in Udupi district. These islands are known for their unique columnar basaltic rock formations and pristine beaches. It's a popular destination for boat rides and picnics.`,
    bestTime: "October to May",
},

{
    ...
    type: "Beach",
    region: "Mangaluru",
    image: SurathkalBeachImg,
    about: `Surathkal Beach is a beautiful beach near Mangalore, known for its rocky coastline and the famous Shri Kinnarshi Temple. The beach is popular among students from the nearby NITK campus and offers stunning sunset views.`,
    bestTime: "October to March",
},

{
    ...
    type: "Beach",
    region: "Mangaluru",
    image: ThannirbhaviBeachImg,
    about: `Thannirbhavi Beach is a serene beach in Mangalore, known for its peaceful atmosphere and beautiful palm groves. The beach is perfect for those looking to escape the crowds and enjoy a quiet day by the Arabian Sea.`,
    bestTime: "October to May",
},

{
    ...
    type: "Beach",
    region: "Kundapura",
    image: MaravantheBeachImg,
    about: `Maravanthe Beach is a unique beach where the NH-66 road runs between the beach and a相连的湖泊. This spectacular sight makes it one of the most photogenic beaches in Karnataka. The beach offers stunning views of both the Arabian Sea and the inland water body.`,
    bestTime: "October to March",
},

{
    ...
    type: "Beach",
    region: "Udupi",
    image: PadubidriBeachImg,
    about: `Padubidri Beach is a beautiful beach in Udupi district, known for its pristine beauty and the annual Padubidri Utsav held here. The beach offers a perfect getaway with its golden sand and clear waters.`,
    bestTime: "October to May",
},
